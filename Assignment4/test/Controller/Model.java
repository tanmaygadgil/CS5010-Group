...
public interface Model {
  ...
  /**
   Increases the brightness of the specified image by the specified increment
   and stores the result in the imageMap with the specified destImage name.
  ...
  /**
   Splits the RGB channels of the image into separate components and stores them as
   individual images in the image map.
