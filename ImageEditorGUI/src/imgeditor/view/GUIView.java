...
/**
 * This interface represents a GUIView. It offers methods for displaying status messages, warning
 * popup messages and methods for each operation that is supported by the program.
 */
public interface GUIView {
  ...
  /**
   * Display an input dialog popup for the number of seeds.
   *
